...
Давай я проверю Google / YouTube / DuckDuckGo / GitHub / RBC / Xvideo / Xvideos2/ Pornhub / var / log / Dyno сециально для вора🤙! 
...
async def _(event):
    ...
    if response_api:
        ...
        await event.edit("Я проверю **Wikipedia** специально для вора🤙:\n👉 [{}]({})\n`Молодец, что решил узнать новое, не забудь сказать жизнь ворам🤙! 😉` ".format(input_str,response_api.rstrip()))
